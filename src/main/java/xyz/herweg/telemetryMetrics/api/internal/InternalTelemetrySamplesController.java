package xyz.herweg.telemetryMetrics.api.internal;

import org.springframework.beans.factory.annotation.Value;
import org.springframework.http.HttpStatus;
import org.springframework.web.bind.annotation.*;
import org.springframework.web.server.ResponseStatusException;
import xyz.herweg.telemetryMetrics.api.internal.dto.IngestTelemetrySamplesRequest;
import xyz.herweg.telemetryMetrics.api.internal.dto.IngestTelemetrySamplesResponse;
import xyz.herweg.telemetryMetrics.data.entity.TelemetryMetricSample;
import xyz.herweg.telemetryMetrics.data.repository.TelemetryMetricSampleRepository;
...
public class InternalTelemetrySamplesController {
    ...
    public IngestTelemetrySamplesResponse ingestSamples(
        ...
        for (var s : request.samples()) {
            ...
            if (s.timestamp().isAfter(now.plusSeconds(60))) {
